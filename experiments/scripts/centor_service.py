...
tor_config = {'SOCKSPort': str(socks_port), 'ControlPort': str(control_port), 'HiddenServiceNonAnonymousMode': str(1), 'HiddenServiceSingleHopMode': str(1), 'DataDirectory': '/tmp/datadir'+str(control_port), 'ExcludeNodes': str(EXCLUDE),}
