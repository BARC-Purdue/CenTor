# https://colab.research.google.com/drive/15sVt-dnaWF9IOzHJFhP-xdirBH5tFPBu?usp=sharing
# Plot to generate uTor and CenTor latency graphs
...
# plt.plot(xInp, yOut[0])
# plt.plot(xInp, yOut[1])
# plt.plot(xInp, yOut[2])
# plt.plot(xInp, yOut[3])
