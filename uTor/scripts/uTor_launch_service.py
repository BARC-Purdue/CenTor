# Onion Server side code to launch with uTor configurations 
...
tor_config = {'SOCKSPort': str(socks_port), 'ControlPort': str(control_port), 'DataDirectory': '/tmp/datadir'+str(control_port), 'ExcludeNodes': str(EXCLUDE),}
